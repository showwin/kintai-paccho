...
class TestTimeRecorder(unittest.TestCase):
    ...
    @mock.patch("components.repo.Employee.get_key", return_value="dummy-employee-key")
    def test_record_clock_in__error(self, mocked_get_key, mocked_record_time, mocked_response_kot_error):
        say = MagicMock()
        request = SlackRequest(channel_id="dummy-channel-id", user_id="dummy-user-id", text="dummy-text")
    ...
    @mock.patch("handler.jp.time_recorder.record_time", side_effect=KOTException)
    @mock.patch("components.repo.Employee.get_key", return_value="dummy-employee-key")
    def test_record_clock_out__error(self, mocked_get_key, mocked_record_time, mocked_response_kot_error):
        say = MagicMock()
        request = SlackRequest(channel_id="dummy-channel-id", user_id="dummy-user-id", text="dummy-text")
    ...
    @mock.patch("handler.jp.time_recorder.record_time", side_effect=KOTException)
    @mock.patch("components.repo.Employee.get_key", return_value="dummy-employee-key")
    def test_record_start_break__error(self, mocked_get_key, mocked_record_time, mocked_response_kot_error):
        say = MagicMock()
        request = SlackRequest(channel_id="dummy-channel-id", user_id="dummy-user-id", text="dummy-text")
    ...
    @mock.patch("handler.jp.time_recorder.record_time", side_effect=KOTException)
    @mock.patch("components.repo.Employee.get_key", return_value="dummy-employee-key")
    def test_record_end_break__error(self, mocked_get_key, mocked_record_time, mocked_response_kot_error):
        say = MagicMock()
        request = SlackRequest(channel_id="dummy-channel-id", user_id="dummy-user-id", text="dummy-text")
